...
<div class="container">
    <a href="{{route('contact_type.create')}}"><button class="btn btn-success">新增</button></a>
    <hr>
...
<script>
    ...
    function destroyBtnFunction(id) {
        const path = `/admin/contact_type/${id}`
