...
export default class InfoType extends Component {
    constructor(props) {
        super(props);
        ...
        // 不同頁面要不同路徑
        axios.post("/admin/info_types_data").then(
            response => {
    ...
    destroyBtnFunction = (id, name) => {
        if (confirm(`是否要刪除 : ${name}`)) {
            // 不同頁面要不同路徑
            const path = `/admin/info_types/${id}`
            ...
            isCreate
                ...
                isUpdate
                    ...
                    <div className="container">
                        <h1 className="display-3 text-center">資訊類型</h1>
