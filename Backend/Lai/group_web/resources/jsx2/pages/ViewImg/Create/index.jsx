...
export default class Create extends Component {
    constructor(props) {
        ...
        axios.post("/admin/upper_data", {
            ...
            response => {
                // 將回傳的上層關連存入state
                this.setState({ upperRelation: response.data, view_id: response.data[0].id })
            }
        )
    }
    ...
    createNewData = async (event) => {
        ...
        // if (checkExist) {
        // 不同頁面要不同路徑
        Axios.post('admin/view_img', formData).then(response => {
    ...
    render() {
        ...
        return (
            <div className="container">
                <h1 className="display-3 text-center">景點圖片 新增</h1>
